        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ToDoLists_AspNetUsers_CreationUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CreationTime = table.Column<DateTime>(type: "TEXT", nullable: false),
                    CreationUserId = table.Column<string>(type: "TEXT", nullable: false),
                    CompletionUserId = table.Column<string>(type: "TEXT", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ToDoListItems", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ToDoListItems_AspNetUsers_CompletionUserId",
                        column: x => x.CompletionUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_ToDoListItems_AspNetUsers_CreationUserId",
                        column: x => x.CreationUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ToDoListShares_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ToDoListItems_CompletionUserId",
                table: "ToDoListItems",
                column: "CompletionUserId");

            migrationBuilder.CreateIndex(
                name: "IX_ToDoListItems_CreationUserId",
                table: "ToDoListItems",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ToDoLists_CreationUserId",
                table: "ToDoLists",
                column: "CreationUserId");
        }
